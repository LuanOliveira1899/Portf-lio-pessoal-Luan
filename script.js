...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const errorMessagem = document.getElementById("error-message");
  ...
  form.addEventListener("submit", function (e) {
    ...
    errorMessagem.style.display = "none";
    loading.style.display = "block";

    const data = {
      to: "luanoliveiradev@hotmail.com",
      from: "lu-oliveira09@hotmail.com",
      subject: "Contato do site",
      text: "Contato do Site",
      html: `<p>Nome: ${nome}</p><br/><p>Email: ${email}<br/><p>Assunto: ${assunto}<br/><p>Mensagem: ${mensagem}</p>`,
    };

    fetch("https://api-mail-gun-mngb.onrender.com/send-email", {
      method: "POST",
      headers: {
